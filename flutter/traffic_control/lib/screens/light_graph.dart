...
class TrafficLightView extends StatelessWidget {
  ...
  Widget _buildSlider(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        color: const Color(0xFF37474F), // Darker gray background
        borderRadius: BorderRadius.circular(16),
        boxShadow: [
          BoxShadow(
            color: const Color(0xFF455A64).withAlpha(100), // Subtle shadow
            blurRadius: 10,
        ...
        children: [
          ...
          Obx(() => SliderTheme(
                data: SliderTheme.of(context).copyWith(
                  activeTrackColor:
                      const Color(0xFF607D8B), // Slate gray for active track
                  inactiveTrackColor:
                      const Color(0xFFB0BEC5), // Light blue for inactive track
                  thumbColor: const Color(0xFF455A64), // Darker gray for thumb
                  overlayColor: const Color(0xFF37474F)
                      .withAlpha(50), // Darker gray overlay
